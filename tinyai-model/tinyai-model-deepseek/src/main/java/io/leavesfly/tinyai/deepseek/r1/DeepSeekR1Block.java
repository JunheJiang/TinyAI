...
public class DeepSeekR1Block extends Block {
    ...
    public static class DeepSeekR1Result {
        ...
        // Getters
        public Variable getLogits() {
            return logits;
        }

        public Variable getReasoningOutput() {
            return reasoningOutput;
        }

        public ReflectionBlock.ReflectionResult getReflectionResult() {
            return reflectionResult;
        }

        public Variable getTransformerOutput() {
    ...
    public List<TransformerBlock> getTransformerLayers() {
        return transformerLayers;
    }

    public ReasoningBlock getReasoningModule() {
        return reasoningModule;
    }

    public ReflectionBlock getReflectionModule() {
