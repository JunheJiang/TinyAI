...
public class ReflectionBlock extends Block {
    ...
    public void init() {
        if (!alreadyInit) {
            ...
            reflectionActivation1 = new ReLuLayer(name + "_reflection_relu1");
            reflectionEvaluatorLayer2 = new LinearLayer(name + "_reflection_eval2", dModel, dModel / 2, true);
            reflectionActivation2 = new ReLuLayer(name + "_reflection_relu2");
            ...
            improvementActivation = new ReLuLayer(name + "_improvement_relu");
    ...
    public static class ReflectionResult {
        ...
        public Variable getImprovementSuggestion() {
            return improvementSuggestion;
        }
